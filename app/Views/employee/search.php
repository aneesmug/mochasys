...
<?php
    ...
    if (session()->get('user')['user_type'] == 'dept_user') {
        $employees  = $employees->where('dept',session()->get('user')['user_dept'])->paginate('12');
    }else{
    ...
    <div class="card-content collapse show">
        ...
        <div class="card-body pb-0">
            <fieldset class="form-group position-relative mb-0">
                <form method="get" action="<?=base_url('/employee/find')?>">
                    <input type="text" class="form-control form-control-xl input-xl" id="iconLeft1" placeholder="Explore your request ..." name="q" onchange="this.form.submit()" autocomplete="off">
                    <div class="form-control-position">
                        <i class="ficon ft-search font-medium-4"></i>
                    </div>
                <form method="get" action="<?=base_url('/employee/find')?>">
            </fieldset>
        </div>
        ...
        <div id="search-results" class="card-body">
            <div class="my-gallery" itemscope="" data-pswp-uid="1">
                ...
                <?php /* ?>
                <div class="text-center">
                    <div><?= $pager->links('default','bootstap_full'); ?></div>
                </div>
                <?php */ ?>
            </div>
