...
<?php
    ...
    if (session()->get('user')['user_type'] == 'employee') {
        $vacations = $vacations->where('emp_id',session()->get('user')['emp_id'])->get()->getResultArray();
    }
    ...
    <div class="users-list-table">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><?= ucfirst($request->uri->getSegment(2)) ?> List</h4>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-6" onclick="$('#approved<?=$vacation['id']?>').show();$('#notapprove<?=$vacation['id']?>').hide();$('#ticket_pay<?=$vacation['id']?>').attr('required', '');$('#permit_fee<?=$vacation['id']?>').attr('required', '');$('#hr_note<?=$vacation['id']?>').removeAttr('required', '');$('#statusa<?=$vacation['id']?>').attr('name','status');$('#reviewa<?=$vacation['id']?>').attr('name','review');$('#statusn<?=$vacation['id']?>').removeAttr('name');">
                    ...
                    <div class="col-6" onclick="$('#notapprove<?=$vacation['id']?>').show();$('#approved<?=$vacation['id']?>').hide();$('#ticket_pay<?=$vacation['id']?>').removeAttr('required', '');$('#permit_fee<?=$vacation['id']?>').removeAttr('required', '');$('#hr_note<?=$vacation['id']?>').attr('required', '');$('#statusn<?=$vacation['id']?>').attr('name','status');$('#statusa<?=$vacation['id']?>').removeAttr('name');$('#reviewa<?=$vacation['id']?>').removeAttr('name');">
...
<?= $this->section('script'); ?>
    ...
    /************************************/
        ...
        $(document).ready(function(){
            ...
            var buttonConfig = [];
            var columnsConfig = [ 0, 1, 2, 3, 4, 5, 6, 7 ];
