            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header card-head-inverse bg-blue">
                        <h4 class="card-title text-white">Register New Location</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">                            
                            ...
                            <form action="<?=base_url('/location/register')?>" method="post">
                                <!-- CSRF token -->
                                <?= csrf_field() ?>
                                <!-- CSRF token -->
                                <fieldset>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control <?= isset($errors['section_name']) ? 'is-invalid' : ''; ?>" id="section_name" placeholder="Enter location name" type="text"name="section_name" value="<?= old('section_name') ?>">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control <?= isset($errors['latitude']) ? 'is-invalid' : ''; ?>" id="latitude" placeholder="Enter google Latitude" type="text" name="latitude" value="<?= old('latitude') ?>">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control <?= isset($errors['longitude']) ? 'is-invalid' : ''; ?>" id="longitude" placeholder="Enter google longitude" type="text" name="longitude" value="<?= old('longitude') ?>">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="t_bulding_size" placeholder="Enter total bulding base in metters" type="text" name="t_bulding_size" value="<?= old('t_bulding_size') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="camera_in" placeholder="Enter camera inside" type="text" name="camera_in" value="<?= old('camera_in') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <label for="camera_out">Camera (OUT)</label>
                                                <input class="form-control" id="camera_out" placeholder="Enter camera outside" type="text" name="camera_out" value="<?= old('camera_out') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="bulding_base">Bulding Base</label>
                                                <input class="form-control" id="bulding_base" placeholder="Enter bulding base" type="text" name="bulding_base" value="<?= old('bulding_base') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="bulding_size">Bulding Size (L * W)</label>
                                                <input class="form-control" id="bulding_size" placeholder="Enter Bulding Size (L * W)" type="text" name="bulding_size" value="<?= old('bulding_size') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="location_dist">District<span class="text-danger">*</span></label>
                                                <input class="form-control <?= isset($errors['location_dist']) ? 'is-invalid' : ''; ?>" id="location_dist" placeholder="Enter District name" type="text"name="location_dist" value="<?= old('location_dist') ?>">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control <?= isset($errors['b_license_no']) ? 'is-invalid' : ''; ?>" id="b_license_no" placeholder="Enter Balady License No." type="text"name="b_license_no" value="<?= old('b_license_no') ?>">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control <?= isset($errors['b_license_exp']) ? 'is-invalid' : ''; ?>" id="b_license_exp" placeholder="Enter Balady License Exp." type="text"name="b_license_exp" value="<?= old('b_license_exp') ?>">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control <?= isset($errors['location_owner']) ? 'is-invalid' : ''; ?>" id="location_owner" placeholder="Enter Location owner" type="text"name="location_owner" value="<?= old('location_owner') ?>">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="municipality" placeholder="Enter Municipality name" type="text"name="municipality" value="<?= old('municipality') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="sub_municipality">Sub-municipality</label>
                                                <input class="form-control" id="sub_municipality" placeholder="Enter sub municipality name" type="text"name="sub_municipality" value="<?= old('sub_municipality') ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="location_name">Location Address<span class="text-danger">*</span></label>
                                                <input class="form-control <?= isset($errors['location_name']) ? 'is-invalid' : ''; ?>" id="location_name" placeholder="Enter location address" type="text"name="location_name" value="<?= old('location_name') ?>">
